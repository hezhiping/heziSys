...
var opts=$(this).combobox("options");
    //return row[opts.textField].toLowerCase().indexOf(q.toLowerCase())==0;//´Ó×óÆ¥Åä
return row[opts.textField].toLowerCase().indexOf(q.toLowerCase()) >= 0;//Ä£ºýÆ¥Åä ·½Î°Ç¿20151007
